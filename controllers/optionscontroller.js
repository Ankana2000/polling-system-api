...
module.exports.create = async function (req, res) {
    try {
        ...
        // Add the vote URL to the option using interpolation
        opt.add_vote = `http://localhost:3000/api/v1/options/${opt._id}/add_vote`;

        // Save the updated option
        await opt.save();

        // Find the question so that we can append the option to its option array
        ...
        // Handle errors, e.g., log the error and send an appropriate response
        console.error(err);
